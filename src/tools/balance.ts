  ...
  if (targets.length === 0) {
    return {
      ...
      setupHint:
        ...
        "fill in. (Manual path: set Q402_TRIAL_API_KEY for BNB Chain sponsored " +
        "free trial (https://q402.quackai.ai/event; Avalanche trial has ended) or Q402_MULTICHAIN_API_KEY " +
